...
export default function TablaClientes() {
  ...
  return (
    <Card className="p-4 md:p-6">
      ...
      <Modal isOpen={modalNuevo} placement={isMobile ? "bottom" : "center"} size={isMobile ? "xs" : "lg"} onOpenChange={setModalNuevo}>
      ...
      <Modal isOpen={isEditOpen} placement={isMobile ? "bottom" : "center"} size={isMobile ? "xs" : "lg"} onOpenChange={onEditClose}>
        <ModalContent className="md:p-2">
